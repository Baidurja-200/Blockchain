...
const INITIAL_INVOICES = [
  {
    ...
    validation: {
      passed: true,
      steps: [
        { key: "poExists", label: "PO Exists?", passed: true, detail: "PO-DEMO-01 found (₹50,000)" },
        ...
        { key: "amountMatches", label: "Amount Matches?", passed: true, detail: "₹50,000 = ₹50,000" },
  ...
  },
  {
    ...
    validation: {
      passed: true,
      steps: [
        { key: "poExists", label: "PO Exists?", passed: true, detail: "PO-DEMO-02 found (₹60,000)" },
        { key: "grnExists", label: "GRN Exists?", passed: true, detail: "GRN-DEMO-02 found (30 received)" },
        { key: "duplicateInvoice", label: "Duplicate Invoice?", passed: true, detail: "No duplicate detected" },
        { key: "amountMatches", label: "Amount Matches?", passed: true, detail: "₹60,000 = ₹60,000" },
